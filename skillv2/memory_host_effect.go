...
func (host *MemoryHost) Apply(command EffectCommand) (EffectResult, error) {
	...
	case ResourceCommand:
		...
		default:
			return EffectResult{}, fmt.Errorf("skillv2: unsupported resource operation %q", payload.Operation)
		}
		if after < 0 {
			return EffectResult{}, ErrInsufficientResource
		}
	...
	default:
		return EffectResult{}, fmt.Errorf("skillv2: unsupported effect command %T", command.Payload)
	}
}
