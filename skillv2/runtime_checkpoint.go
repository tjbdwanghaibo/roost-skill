...
var (
	...
	ErrCheckpointUnsupported  = errors.New("skillv2: runtime checkpoint version is unsupported")
	ErrCheckpointHostMismatch = errors.New("skillv2: runtime checkpoint does not match host state")
	ErrCheckpointProgram      = errors.New("skillv2: runtime checkpoint program cannot be resolved")
)
