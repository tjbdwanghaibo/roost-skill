...
var (
	ErrVisualCatalogMismatch = errors.New("skillv2: visual catalog identity mismatch")
	ErrVisualAssetMissing    = errors.New("skillv2: visual asset is missing")
	ErrVisualMountInvalid    = errors.New("skillv2: presentation mount references an invalid visual")
)
