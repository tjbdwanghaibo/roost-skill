...
func InspectVisualManifest(program *Program) SkillVisualManifest {
	...
	return SkillVisualManifest{Digest: digestStrings("cube.skill/v2/visual-manifest", program.visualCatalogRevision+"/"+program.visualCatalogDigest, parts), Entries: entries}
}
